...
echo -----------------------
#
random_scale.pl Training/Phase1Answers/Phase1Answers-1a.txt Examples/RandomScaled-1a.txt
#
...
echo ---------------------------
#
maxdiff_to_scale.pl Training/Phase2Answers/Phase2Answers-1a.txt Examples/TurkerScaled-1a.txt
#
...
echo ----------------------
#
score_scale.pl Examples/TurkerScaled-1a.txt Examples/RandomScaled-1a.txt \
...
echo ---------------------------
#
scale_to_maxdiff.pl Training/Phase2Questions/Phase2Questions-1a.txt Examples/RandomScaled-1a.txt \
...
echo ------------------------
#
score_maxdiff.pl Training/Phase2Answers/Phase2Answers-1a.txt \
